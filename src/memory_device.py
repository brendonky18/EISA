...
class MemoryDevice(ABC):
    ...
    _clock: Clock = Clock()
    _on_hit: Callable[[MemoryDevice, Any], Any] # MemoryDevice is for the variable self
    _on_miss: Callable[[MemoryDevice, Any], Any] # MemoryDevice is for the variable self

    def __init__(self, addr_size: int, next_device: Union[MemoryDevice, None], read_speed: int, write_speed: int, hit_cb: Callable[[Any], Any], miss_cb: Callable[[Any], Any]): #TODO check if we need to specify read and write speeds seperately
